...
from sqlalchemy import (
    Column, Integer, String, PickleType, Boolean, Index, UniqueConstraint, DateTime, func, Float, Text)
...
from airflow.exceptions import AirflowException, AirflowDagCycleException, AirflowSkipException, AirflowTaskTimeout
...
class DAG(BaseDag, LoggingMixin):
    ...
    def db_merge(self, session=None):
        # DANIEL: TODO horrible cyclic import here
        # BO = BaseOperator
        BO = None
    ...
    def set_state(self, state):
        if self._state != state:
            ...
            if self.dag_id is not None:
                ...
                # DANIEL: TODO cyclic import going on here.
